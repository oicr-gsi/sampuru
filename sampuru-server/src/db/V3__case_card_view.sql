...
library_design,
SUM(CASE WHEN receipt_inspection_qcable_status = 'passed' AND receipt_inspection_qcable_alias IS NOT NULL THEN 1 ELSE 0 END) AS receipt_inspection_completed,
SUM(CASE WHEN receipt_inspection_qcable_alias IS NOT NULL THEN 1 ELSE 0 END) AS receipt_inspection_total,
